    ...
    <form name=alipayment action=alipay.trade.page.pay.jsp method=post
        ...
        <div id="body1" class="show" name="divcontent">
            <dl class="content">
                ...
                <dt>订单名称 ：</dt>
                <dd>
                    <input id="WIDsubject" name="WIDsubject" value="总订单" />
                </dd>
                <hr class="one_line">
                <dt>付款金额 ：</dt>
                <dd>
                    <input id="WIDtotal_amount" name="WIDtotal_amount"  value="<%=account%>"/>
                </dd>
                <hr class="one_line">
                <dt>商品描述：</dt>
                <dd>
                    <input id="WIDbody" name="WIDbody" value="总订单"/>
                </dd>
                <hr class="one_line">
                <dt></dt>
                <dd id="btn-dd">
...
<script language="javascript">
    ...
    function GetDateNow() {
        ...
        <%--document.getElementById("WIDsubject").value = "<%=goods.getTitle()%>";--%>
        <%--document.getElementById("WIDtotal_amount").value = "<%=goods.getPrice()%>";--%>
    }
    GetDateNow();
</script>
</html>